...
<form action="{{route('backend.videoprogress-update')}}" method="POST">
        	...
        	<h4 class="card-title">Higlight Song</h4>
          	<div class="row"> 
                <div class="col-md-12 mb-2">
                    ...
                    <textarea class="form-control" id="editor1" name="higlight_song_links">{{ $videoprogress->higlight_song_links }}</textarea>
                </div>
                <div class="col-md-12 mb-2">
              ...
              <div class="col-md-12 mb-2">
                    ...
                    <textarea class="form-control"  id="editor6" name="higlight_song_note">{{ $videoprogress->higlight_song_note }}</textarea>
                </div>    
        ...
        <div class="card-body"> 
        	<h4 class="card-title">Long Version Song</h4>
          	<div class="row"> 
                <div class="col-md-12 mb-2">
                    <label class="form-label">Description </label> 
                    <textarea class="form-control"  id="editor2" name="lg_ver_song_links">{{ $videoprogress->lg_ver_song_links }}</textarea>
                </div>
                <div class="col-md-12 mb-2">
                    <label class="form-label">Status </label> 
                ...
                <div class="col-md-12 mb-2">
                    <label class="form-label">Notes </label> 
                    <textarea class="form-control"  id="editor5" name="lg_ver_song_note">{{ $videoprogress->lg_ver_song_note }}</textarea>
                </div>
        	</div>
        </div>
    </div>
        ...
        <div class="card-body"> 
        	<h4 class="card-title">Photo for usp cover</h4>
          	<div class="row"> 
                <div class="col-md-12 mb-2">
                    <label class="form-label">Description </label> 
                    <textarea class="form-control"  id="editor3" name="ph_for_usp_cove_links">{{ $videoprogress->ph_for_usp_cove_links }}</textarea>
                </div>
                <div class="col-md-12 mb-2">
                    <label class="form-label">Status </label> 
                ...
                <div class="col-md-12 mb-2">
                    <label class="form-label">Notes </label> 
                    <textarea class="form-control"  id="editor4" name="ph_for_usp_cove_note">{{ $videoprogress->ph_for_usp_cove_note }}</textarea>
                </div>
        	</div>
        </div>
    </div>
    <div class="card"> 
        ...
        <div class="col-md-12 mb-2">
        <label class="form-label">Notes </label> 
        <textarea class="form-control"  id="editor8" name="vid_progress_note">{{ $videoprogress->vid_progress_note }}</textarea>
        </div>
          	<div class="row"> 
                <div class="col-md-12 mb-2">
        ...
        <div class="card-body"> 
        	<h4 class="card-title">Correction Request</h4>
          	...
          	<div class="row"> 
                <div class="col-md-12 mb-2">
                    <label class="form-label">Notes </label> 
                    <textarea class="form-control"  id="editor7" name="correction_note">{{ $videoprogress->correction_note }}</textarea>
                </div>  
        	</div>	
