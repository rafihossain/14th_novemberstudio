                ...
                <table id="datatable" class="table table-bordered table-bordered dt-responsive nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $contactinfo->date_location }}</td>
                            <td>
                                {{-- <a href="{{ route('backend.announcement-edit', $contactinfo->id) }}" class="btn btn-sm btn-primary waves-effect waves-light"><i class="mdi mdi-square-edit-outline"></i></a> --}}
                                
                                <a href="{{ route('backend.order-delete', $contactinfo->id) }}" id="delete" class="btn btn-sm btn-danger waves-effect waves-light">
