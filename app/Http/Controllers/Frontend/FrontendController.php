    ...
    public function getcinema(Request $request){
       ...
       //  echo count($instraffed);die();
        ...
        if(count($cenemas) > 0){
         ...
         //echo 1111.'<br>';
                $html .= '  <div class="col-md-4"> <div class="cinema_item"> <div class="cinema_item_content"> <a href="javascript:void(0)" class="cinema_item_title">'.(isset($cenema['caption'])? Str::limit($cenema['caption'], 40 ):'').'</a> </div> <div class="cinema_item_image"> <a href="javascript:void(0)"> <img src="'.$cenema['media_url'].'" class="img-fluid" alt="cattegory image"/> </a> </div> </div> </div>';     
...
//echo 2222.'<br>';
                ...
                $html .= '<div class="col-md-4 mb-4"> <div class="cinema_item"> <a class="open_modal_and_play_video" href="javascript:void(0)" title="'.(isset($cenema['caption'])? Str::limit($cenema['caption'], 40 ):'').'" data-video-url="'.$cenema['media_url'].'"> <div class="video_lightbox_anchor_image"> <img src="'.$cenema['thumbnail_url'].'" class="img-fluid" alt=""> <div class="cinema_item_content"> <h1>'.(isset($cenema['caption'])? Str::limit($cenema['caption'], 40 ):'').'</h1> </div> </div> </a> </div> </div>'; 
