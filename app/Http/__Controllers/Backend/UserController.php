...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect("backend/$module_name");
    }
    ...
    public function changeProfilePasswordUpdate(Request $request, $id)
    {
        ...
        return redirect("backend/$module_name/profile/$id");
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($id == 1) {
            ...
            return redirect("backend/$module_name")->with('flash_success', 'Update successful!');
        }
